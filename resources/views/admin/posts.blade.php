                      ...
                      <div class="panel panel-default">
                          <div class="panel-body">
                              <form action="{{url('create/post')}}" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div>
                                    <label for="logo" class="col-md-4 control-label">Select image</label>
                                      <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                              <form action="{{url('update/post')}}" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                      <label for="body">Post Body</label>
                                      <textarea class="form-control" id="body" name="body" rows="30" value="hello."></textarea>
                                  </div>
                                  <div class="form-group" style="display:flex;justify-content:space-between;">
                                      <div class="col-md-8 col-md-offset-10">
                                          <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                    ...
                    <table class="table">
                      ...
                      @foreach($posts as $post)
                        <tr>
                          <td>{{$post->id}}</td>     
                          <td>
                            <img src="{{ URL::to('/') }}/images/coffeequery/{{$post->image}}" class="image-thumbnail" width="75">
                          </td>                 
                          <td>{{$post->title}}</td>
                          <td>{{$post->subtitle}}</td>
                          <td>{{ $post->body }}</td>
